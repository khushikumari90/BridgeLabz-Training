...
import com.bridgelabz.fundoonotes.rabbitmq.NoteShareEventProducer;
...
public class NoteService {
    ...
    private final NoteShareEventProducer noteShareEventProducer;

    public NoteService(NoteRepository noteRepository, UserRepository userRepository,
                        ReminderProducer reminderProducer, NoteShareEventProducer noteShareEventProducer) {
        this.noteRepository = noteRepository;
        this.userRepository = userRepository;
        this.reminderProducer = reminderProducer;
        this.noteShareEventProducer = noteShareEventProducer;
    }
    ...
    // UC11: import/export need the current user too, but live outside this Service
    ...
    // stub until Collaborators (UC13) exists properly - just enough to fire the event
    public void shareNote(int noteId, String sharedWithEmail) {
        getNoteDetail(noteId); // confirms the note exists and belongs to the current user
        noteShareEventProducer.publishNoteShared(noteId, sharedWithEmail);
    }
}
